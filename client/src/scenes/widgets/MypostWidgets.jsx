import { EditOutlined, DeleteOutline, AttachFileOutlined, ImageOutlined, MicOutlined, MoreHorizOutlined, GifBoxOutlined } from "@mui/icons-material";
        ...
        <FlexBetween>
            ...
            {isNonMobileScreens ? (
              ...
              <FlexBetween gap='0.25rem'>
                ...
                <Button disable ={!post} onClick={handelPost} 
                 sx={{
